...
#if defined(NDEBUG)
#  if ! defined(CSASHOGI)
const char *str_myname = ( "TenShougiModServer Version " BNZ_VER );
#  else
const char *str_myname = ( "TenShougiModServer Version " BNZ_VER );
#  endif
#else
const char *str_myname = ( "TenShougiModServer Version " BNZ_VER " Debug Build ("
			   __TIME__ " " __DATE__ ")" );
#endif
...
const char *str_book         = "TenShougiModèòî’ä˚ïà.bin";
const char *str_hash         = "TenShougiModâÒîäwèK.bin";
const char *str_fv           = "TenShougiModï]âøä÷êî.bin";
